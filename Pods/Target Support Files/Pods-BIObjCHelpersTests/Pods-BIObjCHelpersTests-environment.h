...
// UIViewShadow
#define COCOAPODS_POD_AVAILABLE_UIViewShadow
#define COCOAPODS_VERSION_MAJOR_UIViewShadow 1
#define COCOAPODS_VERSION_MINOR_UIViewShadow 0
#define COCOAPODS_VERSION_PATCH_UIViewShadow 0
