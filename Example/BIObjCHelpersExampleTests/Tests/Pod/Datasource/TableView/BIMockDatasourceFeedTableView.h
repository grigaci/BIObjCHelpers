...
@property (nonatomic, strong, nullable) BITableViewBatch *__nonnull(^createNextBatchCallback)();
@property (nonatomic, copy, nullable) void(^fetchBatchCallback)(BITableViewBatch * __nonnull);
